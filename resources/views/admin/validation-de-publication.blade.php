                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{route('validé',$item)}}" method="post">
                                                ...
                                                <input type="submit" value="publier"style="background: rgb(247, 247, 244);border-radius:30px;border:orangered">
                                            </form>
                                        </td>
                                        <td>
                                            ...
                                            <form action="{{route('validé',$item)}}" method="post">
                                                @csrf
                                                @method('PUT')
                                                <input type="hidden" name="valideted" value="2">
                                                <input type="submit" value="refuser"style="background: rgb(247, 247, 244);border-radius:30px;border:orangered">
                                            </form>
                                        </td>
                                    </tr>
                                </tbody>
